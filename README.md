...
|**Furkan Mert MISIRLI**|User ve Favourite Crud, Controller |  
...
|**Furkan Mert MISIRLI**|Favori ekleme bölümünde user ve instrument sınıflarında ilişkisel tasarım bölümünde zorlandım. Ekleme ve listeleme işlemlerinde sorun yaşadım. Ekip çalışması ile sorunları çözmüş olduk. |  
